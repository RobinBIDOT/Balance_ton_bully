        ...
        <section>
            ...
            <div class="row my-5">
                ...
                <div class="col-6 col-sm-6 col-lg-3 mb-4">
                    <div class="card">
                        <img src="../ressources/Kevin.jpg" class="card-img-top rounded-2" alt="Kevin">
                        <div class="card-body">
                            <h5 class="cart-title custom-primary">Kevin</h5>
                            <p class="card-text custom-primary">Chef de Projet</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-lg-3 mb-4">
                    <div class="card">
                        <img src="../ressources/Walid.jpg" class="card-img-top rounded-2" alt="Walid">
                        <div class="card-body">
                            <h5 class="cart-title custom-primary">Walid</h5>
                            <p class="card-text custom-primary">Front-End</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-lg-3 mb-4">
                    <div class="card">
                        <img src="../ressources/Robin.jpg" class="card-img-top rounded-2" alt="Robin">
                        <div class="card-body">
                            <h5 class="cart-title custom-primary">Robin</h5>
                            <p class="card-text custom-primary">Back-End</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-lg-3 mb-4">
                    <div class="card">
                        <img src="../ressources/Godwill.jpg" class="card-img-top rounded-2" alt="Godwill">
                        <div class="card-body">
                            <h5 class="cart-title custom-primary">Godwill</h5>
                            <p class="card-text custom-primary">Front-End</p>
                        </div>
                    </div>
                </div>
