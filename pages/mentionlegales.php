...
<div class="container my-5">
    ...
    <section class="mb-5 ml-2">
        <h2 class="custom-secondary">Définitions</h2>
        <p>
    ...
    <section class="mb-5 ml-2">
        <h2 class="custom-secondary">1. Présentation du site internet</h2>
        <p>
    ...
    <section class="mb-5 ml-2">
        <h2 class="custom-secondary">2. Conditions générales d’utilisation du site et des services proposés</h2>
        <p>
            Ces mentions légales RGPD sont issues du générateur gratuit de mentions légales pour un site internet.
        </p>
        <p>
    ...
    <section class="mb-5 ml-2">
        <h2 class="custom-secondary">3. Description des services fournis</h2>
        <p>
    ...
    <section class="mb-5 ml-2">
        <h2 class="custom-secondary">4. Gestion des données personnelles</h2>
        <p>
